...
- `GP-v2e` is implemented based on [SensorsINI/v2e](https://github.com/SensorsINI/v2e). To use it, first download v2e, then replace the corresponding files under `v2ecore/` with the two files provided in `GP-v2e/` (`emulator_gs.py` and `gaussian_filtering.py`). The environment setup is the same as [SensorsINI/v2e](https://github.com/SensorsINI/v2e).
